...
{
  path: 'cadastro/ordem-de-servico',
  component: OrdemDeServicoComponent, canActivate: [AuthGuard]
},
{
  path: 'cadastro/veiculo',
  component: VeiculosComponent, canActivate: [AuthGuard]
},
{
  path: 'cadastro/material',
  component: MateriaisComponent, canActivate: [AuthGuard]
},
{
  path: 'cadastro/taxas-servico',
  component: TaxasServicoComponent, canActivate: [AuthGuard]
},
{
  path: 'cadastro/pre-orcamento',
  component: PreOrcamentoComponent, canActivate: [AuthGuard]
},
{
  path: 'gestao-oserv',
  component: GestaoComponent, canActivate: [AuthGuard]
},
{
  path: 'financeiro-oserv',
  component: FinanceiroComponent, canActivate: [AuthGuard]
},
{
  path: 'parametrizacao',
  component: ParametrizacaoComponent, canActivate: [AuthGuard]
},
{
  path: 'perfil',
