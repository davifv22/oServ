        ...
        <div className="card p-3 mb-4">
          ...
          <div className="row g-2">
            <div className="col-md-6">
              <input className="form-control" placeholder="Título da OS" />
            </div>
            <div className="col-md-6">
            ...
            <div className="col-md-3">
              <input className="form-control" type="number" value={total} onChange={e => setTotal(Number(e.target.value))} />
            </div>
            <div className="col-12">
              <textarea className="form-control" placeholder="Descrição detalhada do serviço" rows={3}></textarea>
            </div>
